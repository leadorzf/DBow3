...
public:
   ...
   */
  // virtual void create(const std::vector<TDescriptor> &training_features);
   ...
   * @param v (out) bow vector of weighted words
   */
  // virtual void transform(const TDescriptor &features, BowVector &v)
  // const;
  /**
...
protected:
   ...
   */
  void HKmeansStep(NodeId parent_id, const std::vector<TDescriptor> &descriptors,
                   int current_level);
   ...
   */
  virtual void initiateClusters(const std::vector<TDescriptor> &descriptors,
   ...
   */
  void initiateClustersKMpp(const std::vector<TDescriptor> &descriptors,
                            std::vector<TDescriptor> &clusters) const;
